...
const DiscoverRecords = ({ onBack, userData }) => {
  const {
    firstName = 'hs',
    lastName = 'mishra',
    gender = 'Male',
  ...
  const handleDiscoverRecords = () => {
    console.log('Discovering records for patient ID:', patientId);
    setIsLoading(true);
  ...
  if (isLoading) {
    return <LoadingAnimation message="Discovering AB-PMJAY Records..." />;
  }
      ...
      <div className="discover-content">
        ...
        <div className="healthcare-program-section">
          ...
          <div className="program-card">
            <div className="program-name">AB - PMJAY</div>
            <div className="program-hip-id">HIP ID: PMJAY</div>
          </div>
        </div>
...
export default DiscoverRecords;
