...
const RCHMoHFWPage = ({ onBack, userData }) => {
  const {
    firstName = 'hs',
    lastName = 'mishra',
    gender = 'Male',
  ...
  const handleDiscoverRecords = () => {
    console.log('Discovering RCH MoHFW records for patient ID:', patientId);
    setIsLoading(true);
  ...
  if (isLoading) {
    return <LoadingAnimation message="Discovering RCH MoHFW Records..." />;
  }
      ...
      <div className="discover-content">
        ...
        <div className="healthcare-program-section">
          ...
          <div className="program-card">
            <div className="program-name">RCH MoHFW</div>
            <div className="program-hip-id">HIP ID: RCH</div>
          </div>
        </div>
