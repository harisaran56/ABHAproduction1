...
const ESanjeevaniHWCPage = ({ onBack, userData }) => {
  const {
    firstName = 'hs',
    lastName = 'mishra',
    gender = 'Male',
  ...
  const handleDiscoverRecords = () => {
    console.log('Discovering eSanjeevani HWC records for patient ID:', patientId);
    setIsLoading(true);
  ...
  if (isLoading) {
    return <LoadingAnimation message="Discovering eSanjeevani-HWC Records..." />;
  }
      ...
      <div className="discover-content">
        ...
        <div className="healthcare-program-section">
          ...
          <div className="program-card">
            <div className="program-name">eSanjeevani-HWC</div>
...
export default ESanjeevaniHWCPage;
