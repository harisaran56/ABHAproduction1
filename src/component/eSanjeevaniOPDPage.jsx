...
const ESanjeevaniOPDPage = ({ onBack, userData }) => {
  const {
    firstName = 'hs',
    lastName = 'mishra',
    gender = 'Male',
  ...
  const handleDiscoverRecords = () => {
    console.log('Discovering eSanjeevani OPD records for patient ID:', patientId);
    setIsLoading(true);
  ...
  if (isLoading) {
    return <LoadingAnimation message="Discovering eSanjeevani OPD Records..." />;
  }
      ...
      <div className="discover-content">
        ...
        <div className="healthcare-program-section">
          ...
          <div className="program-card">
            <div className="program-name">eSanjeevani OPD</div>
            <div className="program-hip-id">HIP ID: eSanjeevani</div>
          </div>
        </div>
...
export default ESanjeevaniOPDPage;
